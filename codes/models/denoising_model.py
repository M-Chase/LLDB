...
class DenoisingModel(BaseModel):
    ...
    def feed_data(self, state, LQ, GT=None):
        self.state = state.to(self.device)    # current_state
    ...
    def optimize_parameters(self, step, timesteps, sde=None):
        ...
        loss = self.loss_fn(xt_1_expection, xt_1_optimum)
    ...
    def test(self, sde=None, save_states=False):
        ...
        with torch.no_grad():
            ...
            self.output = sde.reverse_mean_ode(self.state, save_states=save_states)
